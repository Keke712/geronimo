...
public class Runner : Gtk.Window, ILayerWindow {
    ...
    public void update_list() {
        ...
        while (app != null) {
            // On convertit le score double en int en le multipliant par 100
            // pour garder une certaine précision
            double score = app.app.fuzzy_match(this.entry.text).name;
            app.score = (int)(score * 100);
